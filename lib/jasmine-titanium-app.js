...
var TitaniumObject = Titanium;	// Avoid showing this file's object when activate code assist of "Ti".
TitaniumObject.App.env = 'test';
TitaniumObject.include("/vendor/jasmine-titanium/config/runner-config.js");
TitaniumObject.include("/temp_runner_options.js");
JasmineTitaniumApp = {
  ...
  loadSpecs: function(path) {
    ...
    dir = TitaniumObject.Filesystem.getFile("" + this.spec_dir + path);
